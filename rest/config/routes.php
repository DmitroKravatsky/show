...
return [
    ...
    [
        ...
        'patterns'   => [
            ...
            'POST send-new-email-validation-code'   => 'send-new-email-validation-code',
            'POST verify-new-email'                 => 'verify-new-email',
            'POST send-new-phone-verification-code' => 'send-new-phone-verification-code',
            'POST verify-new-phone'                 => 'verify-new-phone',
        ],
    ],
    [
        'class'      => 'yii\rest\UrlRule',
