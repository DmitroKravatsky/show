...
class m181010_091029_add_user_social extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->alterColumn($this->userTable, 'status', "ENUM('VERIFIED', 'UNVERIFIED', 'BANNED', 'DELETED') DEFAULT 'UNVERIFIED'");
    ...
    public function safeDown()
    {
        ...
        $this->alterColumn($this->tableName, 'status', "ENUM('VERIFIED', 'UNVERIFIED', 'BANNED') DEFAULT 'UNVERIFIED'");
